-- Añade p_country (country_code) al RPC de ranking, para los hubs de PAÍS (/empleos/{cargo}/espana).
-- El filtro de location (ilike ciudad/texto) no sirve para país; country_code es el campo fiable.
