    ...
    >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(7,1fr)", gap: 2 }}>
        {cells.map((d, i) => {
          ...
          if (isSel) { bg = "#0E5C4A"; color = "#fff"; fontWeight = 800; }
          else if (isHov) { bg = "#DCEFE4"; }
          if (isToday && !isSel) { boxShadow = "inset 0 0 0 1.5px #0E5C4A"; color = "#0E5C4A"; fontWeight = 700; }
          ...
          return (
            <div
              ...
              style={{
                ...
                fontWeight, borderRadius: 8, background: bg, color, boxShadow, cursor: "pointer",
              }}
            >
              {d}
            </div>
...
export function DateField({ value, onChange, placeholder = "Seleccionar fecha", disabled, className, style }: DateFieldProps) {
  ...
  return (
    <div ref={containerRef} style={{ position: "relative", display: "inline-block", width: "100%", ...style }} className={cn(className)}>
      ...
      >
        ...
        <span style={{
          flex: 1, textAlign: "left", fontFamily: "'Hanken Grotesk',sans-serif", fontSize: 13.5,
