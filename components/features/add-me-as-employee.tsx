  ...
  if (state === "success") {
    return (
      <div style={{ display: "flex", alignItems: "center", gap: "12px", background: "#DCEFE3", border: "1px solid #B7DCC6", borderRadius: "14px", padding: "16px 18px", marginBottom: "20px" }}>
        ...
        {empId && (
          <Link href={`/employer/employees/${empId}`} style={{ fontFamily: "'Archivo',sans-serif", fontWeight: 700, fontSize: "13px", color: "#0E5C4A", textDecoration: "none", whiteSpace: "nowrap" }}>
