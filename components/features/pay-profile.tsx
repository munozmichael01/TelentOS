  ...
  return (
    <>
        ...
        <div style={{ position: "fixed", inset: 0, zIndex: 50, display: "flex", alignItems: "center", justifyContent: "center" }}>
          ...
          <div style={{ position: "relative", background: T.surface, border: `1.5px solid ${T.line}`, borderRadius: "18px", padding: "24px", width: "100%", maxWidth: "460px", boxShadow: "0 24px 60px -20px rgba(26,26,23,.4)", maxHeight: "90vh", overflowY: "auto" }}>
            ...
            {payslipLoading ? (
              ...
              <>
                <PayslipDetail data={payslipDetail as unknown as PayslipDetailData} locale={locale} />
              </>
            )}
          </div>
        </div>
      ...
      <div>
        {/* Back */}
        <button
          onClick={() => router.push("/employer/payroll/profiles")}
              ...
              <div style={{ background: T.surface, border: `1px solid ${T.line}`, borderRadius: "16px", padding: "20px" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px 24px" }}>
                  <div>
                    ...
                    <a href="/employer/settings/payroll" style={{ fontFamily: "'Space Mono',monospace", fontSize: "10px", color: T.brand, textDecoration: "none", marginTop: "5px", display: "inline-block" }}>
