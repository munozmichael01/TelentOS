  ...
  return (
    <div>
      ...
      <div className="no-print">
        <Link href="/me/payslips" style={{ display: "inline-flex", alignItems: "center", gap: "6px", fontFamily: "'Space Mono',monospace", fontSize: "11px", color: "#79746B", textDecoration: "none", marginBottom: "12px" }}>
