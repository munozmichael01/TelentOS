            ...
            return (
              <HairlineRow key={e.id} align={["left", "left", "right", "left", "left", "right"]}>
                <span style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                  ...
                  <Link href={`/employer/payroll/profiles/${e.id}`} style={{ fontWeight: 700, color: "#1A1A17", textDecoration: "none" }}>{e.name}</Link>
                </span>
                ...
                <Link href={`/employer/payroll/profiles/${e.id}`} style={{ fontFamily: "'Space Mono',monospace", fontSize: "11px", fontWeight: 700, color: "#0E5C4A", textDecoration: "none" }}>
                  Ver →
                </Link>
              </HairlineRow>
            );
