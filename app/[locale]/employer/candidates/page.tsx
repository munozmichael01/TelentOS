  ...
  return (
    <div>
      <PageHeader
        ...
        description={`${rows.length} persona${rows.length !== 1 ? "s" : ""} en tu base de datos.`}
      />
      {rows.length === 0 ? (
        <EmptyState
              ...
              <HairlineRow key={c.id} align={["left", "left", "left", "right", "right", "right"]}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "10px", minWidth: 0 }}>
                  ...
                  <div style={{ minWidth: 0 }}>
                    <Link href={`/employer/candidates/${c.id}`} style={{ fontFamily: "'Archivo',sans-serif", fontWeight: 700, fontSize: "14px", color: "#1A1A17", textDecoration: "none" }}>
                      {c.name}
                    </Link>
