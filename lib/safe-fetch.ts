 ...
 *
 * NOTA: el "IP pinning" (fijar la IP para cerrar DNS-rebinding) se revirtió a
 * propósito (2026-07-14) — introducía riesgo de compatibilidad de red. El residuo
 * de rebinding es bajo (endpoint autenticado + metadata bloqueado) y se revisará
 * más adelante con un enfoque probado (undici) si se decide cerrarlo.
 */
